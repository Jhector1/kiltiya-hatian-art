...
import { stripe } from "@/lib/stripe"; // ensure this is configured with apiVersion: "2024-06-20"
...
export async function POST(req: NextRequest) {
  try {
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.userDesign.upsert({
        ...
        create: {
          ...
          productId,
          style: {},          // minimal seed
          purchased: false,   // top-up ≠ art purchase
          editQuota: edits,
          exportsUsed: 0,
          editsUsed: 0,
        },
    ...
    return NextResponse.json({ applied: true, edits });
  } catch (err: any) {
